...
//========================
    ...
    function startDemo(){
        ...
        createLogo("Gameover", gameOverCanvas, gameOverCanvasBG);
    ...
    function renderGameOver(){
        ...
        var instruction = "Click or tap to fly again.";
        context.font = "bold normal 36px sans-serif";
    ...
    function renderInstructions(){
        var instruction = "Click or tap to fly :)";
        context.font = "bold normal 36px sans-serif";
        context.fillStyle = "#FFFFFF";
